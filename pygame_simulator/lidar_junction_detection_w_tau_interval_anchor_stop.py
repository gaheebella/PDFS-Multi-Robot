...
EXPERIMENT_NAME = "EXP-044 W–tau Safe-Interval and Anchor-Stop Validation"
DEFAULT_OUTPUT = ROOT / "lidar_junction_detection_w_tau_interval_anchor_stop_output"
FROZEN_PARAMETERS = {
...
class AdaptiveRenderer(BaseRenderer):
    ...
    def draw(self, session: AdaptiveSession, paused: bool) -> None:
        ...
        self.text(
            f"EXP-044 Safe Interval + Anchor Stop — {detector_title}",
            (18, 15),
